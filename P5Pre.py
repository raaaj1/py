...
def preemptive_priority_scheduling(processes: List[Process]) -> List[Tuple[int, int]]:
    ...
    while remaining_processes:
        ...
        ready_queue = [p for p in remaining_processes if p.arrival <= current_time]
...
def main():
    ...
    print("\nPreemptive Priority Scheduling:")
    priority_gantt_chart = preemptive_priority_scheduling(processes.copy())
